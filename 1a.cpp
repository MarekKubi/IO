...
int main() {
	...
	ComputerAssembler assembler_d;
	Computer desktop = assembler_d.assembleComputer(desktopBuilder);
	std::cout << "Desktop Computer Configuration:" << std::endl;
	desktop.display();
	LaptopAssembler assembler_l;
	Computer laptop = assembler_l.assembleComputer(desktopBuilder);
